...
import in.calibrage.akshaya.views.Adapter.ChemicalProductAdapter;
...
public class ChemicalActivity extends BaseActivity implements ChemicalProductAdapter.OnClickAck, ChemicalProductAdapter.listner {
    ...
    private ChemicalProductAdapter adapter;
    Double total_amount;
    String amount;
    ...
    private String TAG = "ChemicalActivity";
    private List<ModelLabProducts> product_list = new ArrayList<>();
...
//        });
        ...
        if (isOnline())
            ...
            showDialog(ChemicalActivity.this,getResources().getString(R.string.Internet));
            ...
            public void onClick(View view) {
                ...
                try {
                    if (myProductsList.size() > 0 & !TextUtils.isEmpty(mealTotalText.getText()) & mealTotalText.getText()!= "" ) {
                        ...
                        showDialog(ChemicalActivity.this, getResources().getString(R.string.select_product_toast));
                    }
    ...
    private void parseData(JSONArray array) {
        ...
        for (int i = 0; i < array.length(); i++) {
            ...
            ModelLabProducts superHero = new ModelLabProducts();
...
//
            ...
            adapter = new ChemicalProductAdapter(product_list, this, this);
