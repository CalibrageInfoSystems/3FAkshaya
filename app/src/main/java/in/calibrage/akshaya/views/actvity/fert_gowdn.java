...
public class fert_gowdn extends BaseActivity implements GodownListAdapter.OnItemClickListener {
        ...
        home_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               /* Intent intent =new Intent(getApplicationContext(),HomeActivity.class);
                ...
                Intent intent = new Intent(fert_gowdn.this, HomeActivity.class);
...
//                                    Log.d(TAG, "------ analysis ------ >> get selected_name in String(): " + selected_name);
                            ...
                            showDialog(fert_gowdn.this, fertResponse.getEndUserMessage());
                        }
    ...
    private JsonObject fertReuestobject() {
        ...
        requestModel.setSubcidyAmount(100.0);
        ...
        mSubscription = service.getActiveGodowns(APIConstantURL.GetActiveGodowns + "/" + "AP")
                ...
                .observeOn(AndroidSchedulers.mainThread()).subscribe(new Subscriber<ActiveGodownsModel>() {
                    ...
                    public void onNext(ActiveGodownsModel activeGodownsModel) {
                        ...
                        adapter = new GodownListAdapter(activeGodownsModel.getListResult(), ctx, fert_gowdn.this);
