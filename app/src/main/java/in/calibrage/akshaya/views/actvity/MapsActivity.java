...
public class MapsActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener , OnMapReadyCallback, TaskLoadedCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        CameraPosition googlePlex = CameraPosition.builder()
                ...
                .tilt(45)
                .build();
       // mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(lat, log), 3));
        ...
        if(isFirstTime){
            ...
            getDirection.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    new FetchURL(getDirection.getContext()).execute(getUrl(place1.getPosition(), place2.getPosition(), "driving"), "driving");
                }
            });
            try {
                ...
                place1 = new MarkerOptions().position(new LatLng(location.getLatitude(), location.getLongitude())).title(addresses.get(0).getSubLocality());
                place2 = new MarkerOptions()   .position(new LatLng(lat, log)).title(name);
//
