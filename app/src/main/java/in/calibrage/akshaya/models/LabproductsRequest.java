...
public class LabproductsRequest {
    @SerializedName("listResult")
    @Expose
    private List<LabproductsRequest.ListResult> listResult = null;
    ...
    public List<LabproductsRequest.ListResult> getListResult() {
        return listResult;
    }

    public void setListResult(List<LabproductsRequest.ListResult> listResult) {
